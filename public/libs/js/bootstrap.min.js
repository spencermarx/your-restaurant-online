...
!(function(t, e) {
  ...
  const Te = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[a-z0-9+/]+=*$/i;
  function Se(t, s, e) {
  ...
  const Kn = (function() {
    ...
    return (
      ...
      (t._activate = function(t, e, n) {
        const i = this;
        const o = (!e || (e.nodeName !== 'UL' && e.nodeName !== 'OL')
          ? g(e).children(Fn)
          : g(e).find(Un))[0];
